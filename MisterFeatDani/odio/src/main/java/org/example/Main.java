...
public class Main {
    public static void main(String[] args) {
        ...
        app.get("/registro", ctx -> {
            ...
            ctx.render("registro.ftl", model); // Renderiza la plantilla "registro.ftl"
        });
